...
export default function CalendarPage() {
  ...
  useEffect(() => {
    // Use the backend calendar engine — status + due dates computed server-side
  ...
  function computeEventsForMonth(rules, monthDate) {
    ...
    const events = []
    rules.forEach(rule => {
      const { frequency, due_days_after_period_end: days, status } = rule
      const candidates = []
    ...
    <div className="flex gap-6 animate-fade-in">
      ...
      <div className="flex-1 min-w-0">
        ...
        <div className="card p-3 mb-4 flex items-center gap-6">
          ...
          <p className="ml-auto text-[10px] text-subtext italic">
            Status computed from RBI Master Directions · no manual input
          </p>
        </div>
        ...
        <div className="card p-4 mb-4 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <h3 className="text-base font-semibold text-text w-40 text-center">
